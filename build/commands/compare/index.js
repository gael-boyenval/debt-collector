...
})(
  {
    ...
    'compare/index.tsx': [
      function (require, module, exports) {
        ...
        var useValidatedConfig_1 = __importDefault(
          require('../../lib/config/useValidatedConfig')
        )
                ...
                return __awaiter(_this, void 0, void 0, function () {
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      ...
                      case 4:
                        incrementFn = function () {
                          return setRevisionCheckedFileCount(function (
                            prevCount
                          ) {
                            return prevCount + 1
                          })
                ...
                return __awaiter(_this, void 0, void 0, function () {
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      ...
                      case 4:
                        finalResults = Object.assign.apply(
                          Object,
                          __spreadArray(
                            [{}],
                            __read(
                              fileList.map(function (fileName) {
                                ...
                                var revisionScore = revisionResults.find(
                                  function (_a) {
                                    var filePath = _a.filePath
                                    return filePath === fileName
                                  }
          ...
          return react_1.default.createElement(
            ...
            react_1.default.createElement(
              ...
              react_1.default.createElement(ink_task_list_1.Task, {
                ...
                label: 'checking and comparing with '.concat(
                  revision,
                  ' files'
                ),
                status: ''
                  .concat(checkedRevisionFileCount, '/')
                  .concat(fileList === null ? '?' : fileList.length, ' files'),
              })
            ),
            isConfigValid === false &&
            ...
            finalResult !== null &&
              react_1.default.createElement(ResultReporter_1.ResultsCompare, {
                results: finalResult,
...
//# sourceMappingURL=/compare/index.js.map
