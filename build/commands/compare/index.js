...
},{"./getConfigPath":"../lib/config/getConfigPath.ts","./validateConfig":"../lib/config/validateConfig.ts"}],"compare/index.tsx":[function(require,module,exports) {
"use strict";
...
var useValidatedConfig_1 = __importDefault(require("../../lib/config/useValidatedConfig"));
...
function Compare(_a) {
          ...
          switch (_a.label) {
            ...
            case 4:
              finalResults = Object.assign.apply(Object, __spreadArray([{}], __read(fileList.map(function (fileName) {
                ...
                var revisionScore = revisionResults.find(function (_a) {
                  var filePath = _a.filePath;
                  return filePath === fileName;
                }).totalScore;
  ...
  return react_1.default.createElement(react_1.default.Fragment, null, react_1.default.createElement(ink_task_list_1.TaskList, null, react_1.default.createElement(ink_task_list_1.Task, {
    ...
    label: "checking and comparing with ".concat(revision, " files"),
    status: "".concat(checkedRevisionFileCount, "/").concat(fileList === null ? '?' : fileList.length, " files")
  })), isConfigValid === false && react_1.default.createElement(ink_1.Text, {
    color: "red"
  }, "Error during config"), finalResult !== null && react_1.default.createElement(ResultReporter_1.ResultsCompare, {
    results: finalResult,
...
},{"../../lib/filters/getFilesList":"../lib/filters/getFilesList.ts","../../lib/results/checkFileList":"../lib/results/checkFileList.ts","../../components/ResultReporter":"../components/ResultReporter.tsx","../../lib/config/useValidatedConfig":"../lib/config/useValidatedConfig.ts","../../lib/git":"../lib/git/index.ts"}]},{},["compare/index.tsx"], null)
