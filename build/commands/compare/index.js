...
},{"./utils":"../lib/utils.ts","./validateConfig":"../lib/validateConfig.ts"}],"compare/index.tsx":[function(require,module,exports) {
"use strict";
...
var checkoutBackToCurrent = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [4
              /*yield*/
              , (0, getFilesList_1.default)(updatedConfig, revision, collectFrom)];
          ...
          switch (_a.label) {
            ...
            case 1:
              ...
              finalResults = Object.assign.apply(Object, __spreadArray([{}], __read(fileList.map(function (fileName) {
                ...
                var tendency = revisionScore - currentScore;
