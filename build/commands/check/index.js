...
parcelRequire = (function (modules, cache, entry, globalName) {
...
})(
  {
    ...
    '../lib/reporters/compareMarkdownReport.ts': [
      function (require, module, exports) {
        'use strict'
          ...
          return '\n<br/>\n<br/>\n<b>'
            ...
            .concat(
              fileResult.brokenRules
                .map(function (rule) {
                  return '|\uD83D\uDEAB '
                    .concat(rule.ruleTitle, '|')
                    .concat(rule.ruleTotalSore, '|')
                })
                .join('\n'),
              '\n'
            )
        ...
        var getConclusions = function (data) {
          if (data.totalScores.solde > 0) {
            return '### \u274C Debt score for modified files increased by '.concat(
              data.totalScores.solde,
              ' [^1]'
            )
          }

          if (data.totalScores.solde < 0) {
            return '### \u2705 Debt score for modified files decreased by '.concat(
              data.totalScores.solde,
              ' [^1]'
            )
          }
        ...
        var compareMarkDownReport = function (data) {
          return data.totalScores.rev === 0 && data.totalScores.cur === 0
            ...
            : '\n## Debt collector report\n\n'
                ...
                .concat(data.totalScores.rev.toString(), '|')
                .concat(data.totalScores.cur.toString(), '|')
                .concat(
    ...
    '../components/ResultReporter.tsx': [
      function (require, module, exports) {
        ...
        exports.ResultsCompare =
          exports.ResultsNoMatchRule =
          exports.ResultsFileOnly =
          exports.Results =
            void 0
        ...
        var compareMarkdownReport_1 = __importDefault(
          require('../lib/reporters/compareMarkdownReport')
        )
        ...
        var Results = function (_a) {
          ...
          return react_1.default.createElement(
            ...
            formatedResult.length > 0 &&
              formatedResult.map(function (result) {
                return react_1.default.createElement(
                  ink_1.Box,
                  {
                  ...
                  react_1.default.createElement(ink_table_1.default, {
        ...
        var filterNoMatch = function (results, initialConfig) {
          var allRules = __spreadArray(
            __spreadArray(
              [],
              __read(
                initialConfig.fileRules.map(function (_a) {
                  var id = _a.id,
                    title = _a.title
                  return {
                    id: id,
            ...
            __read(
              initialConfig.eslintRules.map(function (_a) {
                var id = _a.id,
                  title = _a.title
                return {
                  id: id,
          ...
          var allFilesRules = [].concat.apply(
            [],
          ...
          var existingRules = Array.from(
            new Set(__spreadArray([], __read(allFilesRules), false))
          )
        ...
        function ResultsCompare(_a) {
          ...
          var tableResults = Object.keys(results)
          ...
          var totalScores = tableResults.reduce(
            function (acc, res) {
          ...
          var noChangesFiles = tableResults
            .filter(function (item) {
              return item.trend === 0
            })
            .map(function (file) {
          ...
          var moreDeptFiles = tableResults
            .filter(function (item) {
              return item.trend > 0
            })
            .map(function (file) {
          ...
          var lessDeptFiles = tableResults
            .filter(function (item) {
              return item.trend < 0
            })
            .map(function (file) {
      ...
      {
        '../lib/reporters/compareMarkdownReport':
          '../lib/reporters/compareMarkdownReport.ts',
    ...
    'check/index.tsx': [
      function (require, module, exports) {
        ...
        function Check(_a) {
          ...
          var collectingFrom = 'Collecting debt from '.concat(
            changedSince
              ? 'files changed since '.concat(changedSince)
              : include || 'all files'
          )
          var hasFilters = cleanTags.length || rule
          var tagFilters =
            cleanTags.length > 0 && ' [tags : '.concat(cleanTags, ']')
          var and = cleanTags.length > 0 && rule ? ' &' : ''
          var ruleFilter = rule ? ' [rule id : '.concat(rule, ']') : ''
          var withFilters = 'With rules filters on '
            .concat(tagFilters)
            .concat(and)
            .concat(ruleFilter)
          return react_1.default.createElement(
            ...
            react_1.default.createElement(
              ...
              react_1.default.createElement(ink_task_list_1.Task, {
                ...
                status:
                  fileList === null
                    ? null
                    : ''.concat(fileList.length, ' files'),
              }),
              react_1.default.createElement(ink_task_list_1.Task, {
                state: results === null ? 'loading' : 'success',
                label: 'checking files',
                status: ''
                  .concat(checkedFileCount, '/')
                  .concat(fileList === null ? '?' : fileList.length, ' files'),
              })
            ),
            isConfigValid === false &&
              (configErrors === null || configErrors === void 0
                ? void 0
                : configErrors.length) > 0 &&
              configErrors.map(function (error, i) {
                return react_1.default.createElement(
                  ink_1.Text,
                  {
                    key: i,
            ...
            results !== null &&
              ...
              react_1.default.createElement(ResultReporter_1.Results, {
                results: results,
                limitTop: limitTop,
              }),
            results !== null &&
              reportFormat === 'filesOnly' &&
              react_1.default.createElement(ResultReporter_1.ResultsFileOnly, {
                results: results,
                limitTop: limitTop,
              }),
            results !== null &&
              reportFormat === 'noMatchRules' &&
              react_1.default.createElement(
                ResultReporter_1.ResultsNoMatchRule,
                {
                  results: results,
            ...
            react_1.default.createElement(
              ...
              react_1.default.createElement(
                ...
                reportFormat,
                ' ',
                limitTop && '\u2022 top '.concat(limitTop, ' biggest score')
              )
            )
          )
        }
        ...
        Check.propTypes = {
          ...
          reportFormat: prop_types_1.default.oneOf([
            'filesOnly',
            'noMatchRules',
            'standard',
          ]),
      ...
      },
      {
        ...
        '../../components/ResultReporter': '../components/ResultReporter.tsx',
