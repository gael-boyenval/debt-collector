...
parcelRequire = (function (modules, cache, entry, globalName) {
...
})(
  {
    ...
    '../lib/reporters/chartTemplate.ts': [
      function (require, module, exports) {
        'use strict'
    ...
    '../lib/reporters/buildWalkReport.ts': [
      function (require, module, exports) {
        'use strict'
        ...
        var cachePath = ''.concat(
          process.cwd(),
          '/node_modules/.cache/debt-collector'
        )

        var buildWalkReport = function (
          userConfig,
          tags,
          results,
          enDateEstimlations,
          ...
          setTimeout(function () {
            ...
            var resultPath = ''
              .concat(cachePath, '/report-')
              .concat(reportName, '.html')
      ...
      { './chartTemplate': '../lib/reporters/chartTemplate.ts' },
    ],
    '../lib/reporters/packagesEntriesTemplate.ts': [
      function (require, module, exports) {
        'use strict'
    ...
    '../lib/reporters/buildWalkEntries.ts': [
      function (require, module, exports) {
        'use strict'
        ...
        var packagesEntriesTemplate_1 = __importDefault(
          require('./packagesEntriesTemplate')
        )
      ...
      {
        './packagesEntriesTemplate':
          '../lib/reporters/packagesEntriesTemplate.ts',
      },
    ],
    '../lib/config/getTagListFromConfig.ts': [
      function (require, module, exports) {
        'use strict'
        ...
        var getTagListFromConfig = function (config) {
          var allRules = (
            config === null || config === void 0 ? void 0 : config.eslintRules
          )
            ? __spreadArray(
                __spreadArray([], __read(config.fileRules), false),
                __read(config.eslintRules),
                false
              )
            : config.fileRules
                    ...
                    return __generator(this, function (_d) {
                      switch (_d.label) {
                        ...
                        case 2:
                          ...
                          if (
                            !(
                              ((_b = config.walkConfig) === null ||
                              _b === void 0
                                ? void 0
                                : _b.gitCommand) &&
                              ((_c = config.walkConfig) === null ||
                              _c === void 0
                                ? void 0
                                : _c.parser)
                            )
    ...
    '../lib/git/index.ts': [
      ...
      {
        './gitUtils': '../lib/git/gitUtils.ts',
        './useGitUtils': '../lib/git/useGitUtils.ts',
      },
    ],
    '../lib/filters/getFilesList.ts': [
      function (require, module, exports) {
        'use strict'
                        ...
                        switch (_a.label) {
                          case 0:
                            ...
                            return [
                              4,
                              /*yield*/
                              (0, git_1.getChangedFilesSinceRev)(
                                compare,
                                commonAncestor
                          ...
                          case 1:
                            ...
                            files = (0, utils_1.filterIgnoredFiles)(
                              allChanges,
                              config.exclude,
                              includedGlob
                            )
              ...
              return [
                ...
                new Promise(function (resolve, reject) {
                  try {
                    ...
                    var filesFromSource = includedGlob.map(function (
                      globFilter
                    ) {
                      return glob_1.default.sync(globFilter, globOptions_1)
                    })
                    var files = utils_1.mergeAndDedupArrays
                      .apply(
                        void 0,
                        __spreadArray([], __read(filesFromSource), false)
                      )
                      .map(removeDotSlash)
                    resolve(files)
                  } catch (error) {
      ...
      { '../utils': '../lib/utils/index.ts', '../git': '../lib/git/index.ts' },
    ],
    '../lib/filters/filterRules.ts': [
      function (require, module, exports) {
        'use strict'
        ...
        var doesMatchPath = function (_a, file) {
          ...
          return (
            include.filter(function (glob) {
              return (0,
              minimatch_1.default)(file.replace('./', ''), glob.replace('./', ''))
            }).length > 0
          )
        }
        ...
        var getRulesForFile = function (options, filePath) {
          ...
          if (options.eslintRules) {
            rulesForFile.eslintRules = options.eslintRules.filter(function (
              rule
            ) {
              return doesMatchPath(rule, filePath)
            })
        ...
        var filtersRulesFromOptions = function (options, ruleId, tags) {
          ...
          if (
            ruleId ||
            (cleanTag === null || cleanTag === void 0
              ? void 0
              : cleanTag.length)
          ) {
            fileRules = filterRulesByTagAndId(
              (_a = options.fileRules) !== null && _a !== void 0 ? _a : [],
              ruleId,
              cleanTag
            )
            eslintRules = filterRulesByTagAndId(
              (_b = options.eslintRules) !== null && _b !== void 0 ? _b : [],
              ruleId,
              cleanTag
            )
          }
    ...
    '../lib/results/getFileRulesErrors.ts': [
      function (require, module, exports) {
        'use strict'
        ...
        var escape_string_regexp_node_1 = __importDefault(
          require('escape-string-regexp-node')
        )
        ...
        var findJsImportFrom = function (data) {
          return function (importee, from) {
            var regexp = new RegExp(
              'import [A-z0-9,\\s{]*'
                .concat(
                  (0, escape_string_regexp_node_1.default)(importee),
                  "[A-z0-9,\\s}]* from '[A-z0-9./]*"
                )
                .concat(
                  (0, escape_string_regexp_node_1.default)(from),
                  "[A-z0-9./]*'"
                ),
              'gm'
            )
        ...
        var countAll = function (data) {
          return function (str) {
            ...
            if (str instanceof RegExp) {
              ...
              regexp = new RegExp(
                (0, escape_string_regexp_node_1.default)(str),
                'g'
              )
            }
    ...
    '../lib/results/getEslintRulesErrors.ts': [
      function (require, module, exports) {
        'use strict'
    ...
    '../lib/results/getFileResult.ts': [
      function (require, module, exports) {
        ...
        var getFileRulesErrors_1 = __importDefault(
          require('./getFileRulesErrors')
        )

        var getEslintRulesErrors_1 = __importDefault(
          require('./getEslintRulesErrors')
        )
            ...
            return __generator(this, function (_e) {
              switch (_e.label) {
                case 0:
                  ...
                  if (
                    ((_a = config.eslintRules) === null || _a === void 0
                      ? void 0
                      : _a.length) === 0 &&
                    ((_b = config.fileRules) === null || _b === void 0
                      ? void 0
                      : _b.length) === 0
                  ) {
                    return [
                  ...
                  if (
                    ((_c = config.fileRules) === null || _c === void 0
                      ? void 0
                      : _c.length) > 0
                  ) {
                    if (data) {
                      fileRulesResults = (0, getFileRulesErrors_1.default)(
                        config,
                        filePath,
                        data
                      )
                  ...
                  if (
                    !(
                      ((_d = config.eslintRules) === null || _d === void 0
                        ? void 0
                        : _d.length) > 0 && eslint
                    )
                  )
                  ...
                  return [
                    4,
                    /*yield*/
                    (0, getEslintRulesErrors_1.default)(
                      config,
                      filePath,
                      data,
                      eslint
        ...
        var getFileResult = function (config, file, incrementCounter, eslint) {
          return __awaiter(void 0, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  rulesForFile = (0, filterRules_1.getRulesForFile)(
                    config,
                    file
                  )
                  return [
                    ...
                    /*yield*/
                    runFileChecks(
                      __assign(__assign({}, config), rulesForFile),
                      file,
                      eslint
                    ),
                  ]
      ...
      {
        '../filters/filterRules': '../lib/filters/filterRules.ts',
        './getFileRulesErrors': '../lib/results/getFileRulesErrors.ts',
        './getEslintRulesErrors': '../lib/results/getEslintRulesErrors.ts',
        '../utils': '../lib/utils/index.ts',
      },
    ],
    '../lib/results/checkFileList.ts': [
      function (require, module, exports) {
        'use strict'
            ...
            return __generator(this, function (_a) {
              return [
                ...
                new Promise(function (resolve) {
                  ...
                  var filteredRules = (0,
                  filterRules_1.filtersRulesFromOptions)(config, rule, tags)

                  var fileListConfig = __assign(
                    __assign({}, config),
                    filteredRules
                  )
                  ...
                  queue.enqueue(
                    fileList.map(function (file) {
                      return function () {
                        return (0,
                        getFileResult_1.default)(fileListConfig, file, increment, eslint)
                      }
                    })
                  )
      ...
      {
        './getFileResult': '../lib/results/getFileResult.ts',
        '../filters/filterRules': '../lib/filters/filterRules.ts',
      },
    ],
    'walk/getCommitResult.ts': [
      function (require, module, exports) {
        'use strict'
        ...
        var getFilesList_1 = __importDefault(
          require('../../lib/filters/getFilesList')
        )

        var checkFileList_1 = __importDefault(
          require('../../lib/results/checkFileList')
        )

        var formatWalkResults = function (
          config,
          results,
          globFilter,
          hasPackagesConfig
          ...
          var allRulesIdInConfig = __spreadArray(
            __spreadArray(
              [],
              __read(
                fileRules.map(function (rule) {
                  return rule
                })
              ),
              false
            ...
            if (hasPackagesConfig) {
              filteredResults = Object.keys(filesResults)
                .filter(function (filePath) {
                  return (0,
                  minimatch_1.default)(filePath, globFilter.replace(/^\.\//, ''))
                })
              ...
              switch (_a.label) {
                ...
                case 2:
                  ...
                  if (previousResult) {
                    ...
                    mergedResults = __assign(
                      __assign({}, previousResult),
                      mergedResults
                    ) // testing for deleted, moved or rennamed files, and removing them from the results

                    mergedResults = Object.keys(mergedResults).reduce(function (
                      acc,
                      filePath
                    ) {
                      var fileStillExist = fs_1.default.existsSync(
      ...
      {
        '../../lib/filters/getFilesList': '../lib/filters/getFilesList.ts',
        '../../lib/results/checkFileList': '../lib/results/checkFileList.ts',
      },
    ],
    'walk/getEndDatesEstimations.ts': [
      function (require, module, exports) {
        'use strict'
        ...
        var getDateRulesDatas = function (_a) {
          ...
          var allRules = __spreadArray(
            __spreadArray(
              [],
              __read(
                (_b = initialConfig.fileRules) !== null && _b !== void 0
                  ? _b
                  : []
              ),
              false
            ...
            __read(
              (_c = initialConfig.eslintRules) !== null && _c !== void 0
                ? _c
                : []
            ),
            false
    ...
    'walk/index.tsx': [
      function (require, module, exports) {
        ...
        var buildWalkReport_1 = __importDefault(
          require('../../lib/reporters/buildWalkReport')
        )

        var buildWalkEntries_1 = __importDefault(
          require('../../lib/reporters/buildWalkEntries')
        )

        var getTagListFromConfig_1 = __importDefault(
          require('../../lib/config/getTagListFromConfig')
        )
        ...
        var getEndDatesEstimations_1 = __importDefault(
          require('./getEndDatesEstimations')
        )
          ...
          var walkTask = {
            ...
            status:
              walkTaskState === 'loading'
                ? 'checking commit '
                    .concat(currentCommit.index, '/')
                    .concat(revlength, ' : ')
                    .concat(currentCommit.commit)
                : walkTaskState,
          }
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        ...
                        setTags(
                          (0, getTagListFromConfig_1.default)(sanitizedConfig)
                        )
                        return [
                          4,
                          /*yield*/
                                    ...
                                    switch (_c.label) {
                                      case 0:
                                        ...
                                        return [
                                          ...
                                          /*yield*/
                                          (0,
                                          getCommitResult_1.getCommitResult)(
                                            previousResult === null ||
                    ...
                    if (isReady) {
                      hasPackagesConfig_1 =
                        ...
                        !!((_b =
                          (_a =
                            sanitizedConfig === null ||
                            sanitizedConfig === void 0
                              ? void 0
                              : sanitizedConfig.walkConfig) === null ||
                          _a === void 0
                            ? void 0
                            : _a.report) === null || _b === void 0
                          ? void 0
                          : _b.packages)
                      reports_1 = hasPackagesConfig_1
                        ? sanitizedConfig.walkConfig.report.packages
                        : {
                            global: sanitizedConfig.include,
                          }
                      reportsLinks_1 = Object.keys(reports_1).map(function (
                        report
                      ) {
                        return {
                          name: report,
                      ...
                      Object.keys(reports_1).forEach(function (reportName) {
                        var formatedResult = (0,
                        getCommitResult_1.formatWalkResults)(
                          sanitizedConfig,
                          results,
                          reports_1[reportName],
                          hasPackagesConfig_1
                        )
                        var endDateEstimations = (0,
                        getEndDatesEstimations_1.default)({
                          initialConfig: userConfig,
                          results: formatedResult,
                        })
                        ;(0,
                        buildWalkReport_1.default)(userConfig, tags, formatedResult, endDateEstimations, reportName, reportsLinks_1)
                      })
                      ;(0, buildWalkEntries_1.default)(
                        reportsLinks_1,
                        openReport
                      )
                      setIsFinished(true)
      ...
      },
      {
        ...
        '../../lib/reporters/buildWalkReport':
          '../lib/reporters/buildWalkReport.ts',
        '../../lib/reporters/buildWalkEntries':
          '../lib/reporters/buildWalkEntries.ts',
        '../../lib/config/getTagListFromConfig':
          '../lib/config/getTagListFromConfig.ts',
        '../../lib/git': '../lib/git/index.ts',
        './getCommitResult': 'walk/getCommitResult.ts',
        './getEndDatesEstimations': 'walk/getEndDatesEstimations.ts',
      },
    ],
  },
  {},
